...
The script has logic to clean up files with certain extensions ([see script](./repo-migrations.sh)); and files with sizes reaching a defined value, the default is 5 Megabytes (5M).
